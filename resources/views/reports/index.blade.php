    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                ...
                @canany(['report-financial-general-ledger', 'report-financial-trial-balance', 'report-financial-account-balances', 'report-financial-balance-sheet', 'report-financial-income-statement', 'supplier-payment-list', 'report-audit-opening-customer-balance'])
                    <div x-data="{ open: true }" class="bg-white rounded-lg shadow overflow-hidden">
                        <button @click="open = !open" type="button"
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <h3 class="text-lg font-bold text-gray-800">Financial Statements</h3>
                            </div>
                    ...
                    <div x-data="{ open: true }" class="bg-white rounded-lg shadow overflow-hidden">
                        <button @click="open = !open" type="button"
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <h3 class="text-lg font-bold text-gray-800">Receivables & Core Reports</h3>
                            </div>
                            <svg class="w-5 h-5 text-gray-400 transition-transform duration-200"
                                :class="{ 'rotate-180': open }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                                    ...
                                    <a href="{{ route('reports.claim-register.index') }}"
                                        ...
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <div class="text-xs text-gray-500">Supplier claims and recovery tracking
                                                </div>
                                            </div>
                                        </div>
                                        <svg class="w-4 h-4 text-gray-400 group-hover:text-gray-600 transition-colors"
                                    ...
                                    <a href="{{ route('reports.ledger-register.index') }}"
                                        ...
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <div class="text-xs text-gray-500">Supplier transaction ledger with running
                                                    balance</div>
                                            </div>
                                        </div>
                                        <svg class="w-4 h-4 text-gray-400 group-hover:text-gray-600 transition-colors"
                                ...
                                @can('report-audit-expense-detail')
                                    <a href="{{ route('reports.expense-detail.index') }}"
                                        ...
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div>
                                                <div class="text-sm font-semibold text-gray-900">Expense Detail</div>
                                                <div class="text-xs text-gray-500">Track & manage operational expenses by category</div>
                                            </div>
                                        </div>
                                        <svg class="w-4 h-4 text-gray-400 group-hover:text-gray-600 transition-colors"
                                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                @canany(['report-sales-goods-issue', 'report-sales-daily-sales'])
                    <div x-data="{ open: true }" class="bg-white rounded-lg shadow overflow-hidden">
                        <button @click="open = !open" type="button"
                            class="w-full flex items-center justify-between px-6 py-4 hover:bg-gray-50 transition-colors duration-150">
                            <div class="flex items-center gap-3">
                        ...
                        <div x-show="open" x-collapse>
                            <div class="border-t border-gray-100 divide-y divide-gray-100">
                                ...
                                @can('report-sales-vehicle')
                                    <a href="{{ route('reports.vehicle.index') }}"
                                        class="flex items-center justify-between px-4 py-2 hover:bg-gray-50 transition-colors duration-150 group">
                                        <div class="flex items-center gap-4">
                                            <span class="flex-shrink-0 w-5 text-xs font-bold text-gray-400 text-right">3</span>
                                            <div
                                            ...
                                            <div>
                                                <div class="text-sm font-semibold text-gray-900">Vehicle Report</div>
                                                <div class="text-xs text-gray-500">Fleet details and assignments</div>
                                            </div>
                                        </div>
                                        <svg class="w-4 h-4 text-gray-400 group-hover:text-gray-600 transition-colors"
                                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                @can('report-audit-invoice-summary')
                                    <a href="{{ route('reports.invoice-summary.index') }}"
                                        ...
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div>
                                                <div class="text-sm font-semibold text-gray-900">Invoice Summary</div>
                                                <div class="text-xs text-gray-500">Supplier invoice summary with tax breakdown
                                                </div>
                                            </div>
                                        </div>
                                        <svg class="w-4 h-4 text-gray-400 group-hover:text-gray-600 transition-colors"
