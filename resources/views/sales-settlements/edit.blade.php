    ...
    @push('scripts')
        <script>
            ...
            function updateSalesSummary() {
                ...
                // Note: In edit mode, cashSalesAmount is derived from denominations, but for "Expected" 
                // we need the theoretical cash sales (Total Sale - Credit - Cheque - Bank)
                const theoreticalCashSales = Math.round((netSale - creditSalesAmount - chequeSalesAmount - bankSalesAmount) * 100) / 100;
