        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-12 gap-6">
                ...
                <a href="{{ route('reports.trial-balance.index') }}"
                    ...
                    <div class="p-5 flex justify-between">
                        <div>
                            <div class="text-3xl font-bold leading-8">TB</div>
                            <div class="mt-1 text-base font-extrabold text-black">Trial Balance</div>
                        </div>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                ...
                <a href="{{ route('reports.account-balances.index') }}"
                    ...
                    <div class="p-5 flex justify-between">
                        <div>
                            <div class="text-3xl font-bold leading-8">AB</div>
                            <div class="mt-1 text-base font-extrabold text-black">Account Balances</div>
                        </div>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                ...
                <a href="{{ route('reports.balance-sheet.index') }}"
                    ...
                    <div class="p-5 flex justify-between">
                        <div>
                            <div class="text-3xl font-bold leading-8">BS</div>
                            <div class="mt-1 text-base font-extrabold text-black">Balance Sheet</div>
                        </div>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                ...
                <a href="{{ route('reports.income-statement.index') }}"
                    ...
                    <div class="p-5 flex justify-between">
                        <div>
                            <div class="text-3xl font-bold leading-8">IS</div>
                            <div class="mt-1 text-base font-extrabold text-black">Income Statement</div>
                        </div>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
