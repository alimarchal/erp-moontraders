<x-app-layout>
    <x-slot name="header">
        <x-page-header title="Bank Accounts" :createRoute="route('bank-accounts.create')" createLabel="Add Bank Account"
            createPermission="bank-account-create" :showSearch="true" :showRefresh="true" backRoute="settings.index" />
    </x-slot>
    ...
    <x-data-table :items="$accounts" :headers="[
        ...
        :emptyRoute="route('bank-accounts.create')" emptyLinkText="Add a bank account">
