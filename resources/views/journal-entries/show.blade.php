    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm text-gray-700 dark:text-gray-200">
                    <div>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                <div class="p-6">
                    <h3 class="text-lg font-semibold text-gray-700 dark:text-gray-200 mb-4">Detail Lines</h3>
                            ...
                            <tbody class="text-black text-md leading-normal font-semibold">
                                @foreach ($journalEntry->details as $index => $detail)
                                    <tr class="border-b border-gray-200">
                                        ...
                                        <td class="py-2 px-2 text-left">
                                            {{ $detail->costCenter?->code ? $detail->costCenter->code . ' · ' . $detail->costCenter->name : '—' }}
                                        </td>
                    ...
                    <p class="text-xs text-gray-500 mt-2">Journal entries must remain balanced. Debits should equal credits.</p>
                </div>
            </div>
                    ...
                    <div class="p-6">
                        ...
                        <ul class="space-y-2 text-sm text-gray-700 dark:text-gray-300">
                            @foreach ($journalEntry->attachments as $attachment)
                                <li class="flex items-center justify-between border border-gray-200 dark:border-gray-700 rounded-md px-3 py-2">
                                    <div>
