<x-app-layout>
    ...
    <div x-data="{ showBankSummary: {{ $showBankSummary ? 'true' : 'false' }} }">
        <x-filter-section :action="route('reports.investment-summary.index')" class="no-print">
            ...
            <div class="mt-3 flex items-center gap-2">
                <input type="checkbox" id="show_bank_summary" name="show_bank_summary" value="1"
                    x-model="showBankSummary" @checked($showBankSummary)
                    class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" />
                <label for="show_bank_summary" class="text-sm text-gray-700 cursor-pointer">
                    Show Bank / Cash Summary &amp; Investment Comparison
                </label>
            </div>
        </x-filter-section>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 pb-16 mt-4">
            <div class="bg-white overflow-hidden p-4 shadow-xl sm:rounded-lg mb-4 print:shadow-none print:pb-0">
                <div class="overflow-x-auto">
                            ...
                            <table class="report-table tabular-nums w-full">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right px-2 py-1 font-mono">{{ number_format($claimAmount, 2) }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text-center px-1 py-1">4</td>
                                        <td class="px-2 py-1">Stock Amount</td>
                                        <td class="text-right px-2 py-1 font-mono">{{ number_format($stockAmount, 2) }}
                                        </td>
                                    </tr>
                                    <tr>
                    ...
                    <div :class="{ 'no-print-section': !showBankSummary }"
                        ...
                        <div>
                            <table class="report-table tabular-nums w-full">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="text-center px-1 py-1">1</td>
                                        <td class="px-2 py-1">Last Month Main Investment
                                    ...
                                    <tr class="bg-gray-50 font-extrabold">
                                        ...
                                        <td class="px-2 py-1 border-t-2 border-black">Increase In Investment Current
                                            Month
                                        </td>
                                        <td
