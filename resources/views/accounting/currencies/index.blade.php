<x-app-layout>
    <x-slot name="header">
        <x-page-header title="Currencies" :createRoute="route('currencies.create')" createLabel="Add Currency"
            createPermission="currency-create" :showSearch="true" :showRefresh="true" backRoute="settings.index" />
    </x-slot>
    ...
    <x-data-table :items="$currencies" :headers="[
        ...
        :emptyRoute="route('currencies.create')" emptyLinkText="Add a currency">
