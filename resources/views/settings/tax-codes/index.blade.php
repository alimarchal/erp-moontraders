<x-app-layout>
    <x-slot name="header">
        <x-page-header title="Tax Codes" :createRoute="route('tax-codes.create')" createLabel="Add Tax Code"
    ...
    <x-data-table :items="$taxCodes" :headers="[
        ...
        :emptyRoute="route('tax-codes.create')" emptyLinkText="Add a tax code">
