    ...
    <x-data-table :items="$stocks" :headers="[
        ...
        <tr class="border-b border-gray-200 dark:border-gray-700 text-sm">
            ...
            <td class="py-1 px-2 text-center">
                ...
                <span
                    class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-orange-100 text-orange-800 dark:bg-orange-900 dark:text-orange-200 ml-1">
                    P:{{ $stock->promotional_batches }}
                </span>
                @endif
                @if($stock->priority_batches > 0)
                <span
                    class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-200 ml-1">
