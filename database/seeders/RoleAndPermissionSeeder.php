...
class RoleAndPermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $permissions = [
            ...
            // Sales & Distribution
            'sales-settlement' => ['list', 'create', 'edit', 'delete', 'post', 'revert', 'view-own', 'view-all'],
