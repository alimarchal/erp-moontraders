        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-12 gap-6">
                    ...
                    <a href="{{ route('warehouses.index') }}"
                        ...
                        <div class="p-5 flex justify-between">
                            <div>
                                ...
                                <div class="mt-1 text-base font-extrabold text-black uppercase">Warehouses</div>
                            </div>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                ...
                @can('warehouse-type-list')
                    <!-- Warehouse Types Module Card -->
                    <a href="{{ route('warehouse-types.index') }}"
                        class="transform hover:scale-110 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 md:col-span-3 lg:col-span-3 intro-y bg-white block">
                        <div class="p-5 flex justify-between">
                            <div>
                                <div class="text-3xl font-bold leading-8">{{ \App\Models\WarehouseType::count() }}</div>
                                <div class="mt-1 text-base font-extrabold text-black uppercase">Warehouse Types</div>
                            </div>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
