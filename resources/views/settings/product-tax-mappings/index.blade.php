<x-app-layout>
    <x-slot name="header">
        <x-page-header title="Product Tax Mappings" :createRoute="route('product-tax-mappings.create')"
            createLabel="Add Mapping" :showSearch="true" :showRefresh="true" backRoute="settings.index" />
    </x-slot>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div>
                ...
                <select id="filter_transaction_type" name="filter[transaction_type]"
                    ...
                    <option value="sales" {{ request('filter.transaction_type')==='sales' ? 'selected' : '' }}>Sales</option>
                    <option value="purchase" {{ request('filter.transaction_type')==='purchase' ? 'selected' : '' }}>Purchase</option>
                    <option value="both" {{ request('filter.transaction_type')==='both' ? 'selected' : '' }}>Both</option>
                </select>
            </div>
    ...
    ]" emptyMessage="No product tax mappings found." :emptyRoute="route('product-tax-mappings.create')"
        emptyLinkText="Add a mapping">
