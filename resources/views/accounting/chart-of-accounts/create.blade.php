                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <x-input id="account_code" type="text" name="account_code"
                                    class="mt-1 block w-full" :value="old('account_code')" required autofocus
                            ...
                            <div>
                                ...
                                <x-input id="account_name" type="text" name="account_name"
                                    class="mt-1 block w-full" :value="old('account_name')" required
                            ...
                            <div>
                                ...
                                <select id="account_type_id" name="account_type_id"
                                    ...
                                    @foreach ($accountTypes as $typeId => $typeName)
                                        <option value="{{ $typeId }}" {{ old('account_type_id') == $typeId ? 'selected' : '' }}>
                                            {{ $typeName }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <select id="normal_balance" name="normal_balance"
                                    ...
                                    @foreach ($normalBalances as $value => $label)
                                        <option value="{{ $value }}" {{ old('normal_balance') == $value ? 'selected' : '' }}>
                                            {{ $label }}
                                        </option>
                                    @endforeach
                                </select>
