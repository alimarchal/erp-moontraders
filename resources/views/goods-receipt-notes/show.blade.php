                                    ...
                                    <tr class="border-b border-gray-200 text-sm">
                                        ...
                                        <td class="py-1 px-2">
                                            ...
                                            @if ($item->is_promotional)
                                                <span class="px-2 py-1 mt-1 text-xs font-semibold rounded bg-orange-100 text-orange-800">
                                                    Promotional
                                                </span>
                                            @endif
                    ...
                    <x-slot name="footer">
                        <tr class="border-t-2 border-gray-300">
                            ...
                            <td class="py-1 px-2 text-right font-bold text-md text-emerald-600">
                                ₨ {{ number_format(
    $grn->items->sum('total_value_with_taxes') ?: $grn->grand_total,
    2
) }}
                            </td>
                        </tr>
                ...
                @if ($grn->status === 'posted')
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6 p-4">
                                <div>
