<x-app-layout>
    <x-slot name="header">
        <x-page-header title="Accounting Periods" :createRoute="route('accounting-periods.create')"
            createLabel="Add Period" createPermission="accounting-period-create" :showSearch="true" :showRefresh="true"
    ...
    <x-data-table :items="$periods" :headers="[
        ...
        :emptyRoute="route('accounting-periods.create')" emptyLinkText="Add a period">
        @foreach ($periods as $index => $period)
            ...
            @endphp
            <tr class="border-b border-gray-200 text-sm {{ $period->isCurrent() ? 'bg-emerald-50/40' : '' }}">
