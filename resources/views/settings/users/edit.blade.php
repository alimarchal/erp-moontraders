<x-app-layout title="Edit User">
    <x-page-header title="Edit User: {{ $user->name }}" :breadcrumbs="[
        ['label' => 'Settings', 'url' => '#'],
                ...
                <div class="bg-white dark:bg-gray-800 shadow rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700">
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 border-b border-gray-100 dark:border-gray-700 pb-6">
                            ...
                            <div>
                                ...
                                <x-input id="email" name="email" type="email" class="mt-1 block w-full bg-gray-50 dark:bg-gray-700 text-gray-500" :value="$user->email" readonly />
                            ...
                            <div>
                                ...
                                <x-input id="password" name="password" type="password" class="mt-1 block w-full" placeholder="Leave blank to keep current password" />
                            </div>
                    ...
                    <div class="px-6 py-4 bg-gray-50 dark:bg-gray-900/50 flex items-center justify-end space-x-3">
                        <x-button type="submit" class="bg-indigo-600 hover:bg-indigo-700">
                            Update User Permissions & Profile
                        </x-button>
                    </div>
                </div>
            </form>
