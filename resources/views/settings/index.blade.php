    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                ...
                @canany(['account-type-list', 'chart-of-account-list', 'currency-list', 'accounting-period-list', 'investment-opening-balance-list', 'bank-account-list', 'cost-center-list'])
                    <div x-data="{ open: true }" class="bg-white rounded-lg shadow overflow-hidden">
                        <button @click="open = !open" type="button"
                            class="w-full flex items-center justify-between px-6 py-4 hover:bg-gray-50 transition-colors duration-150">
                            <div class="flex items-center gap-3">
                        ...
                        <div x-show="open" x-collapse>
                            <div class="border-t border-gray-100 divide-y divide-gray-100">
                                ...
                                @can('investment-opening-balance-list')
                                    <a href="{{ route('investment-opening-balances.index') }}"
                                        class="flex items-center justify-between px-6 py-3 hover:bg-gray-50 transition-colors duration-150 group">
                                        <div class="flex items-center gap-4">
                                            <div
                                                class="flex-shrink-0 w-10 h-10 rounded-lg bg-orange-50 flex items-center justify-center text-orange-600">
                                            ...
                                            <div>
                                                <div class="text-sm font-semibold text-gray-900">Investment Opening Balances</div>
                                                <div class="text-xs text-gray-500">Supplier-wise opening investment amounts</div>
                                            </div>
                                        </div>
                                        <div class="flex items-center gap-3">
                                            <span
                                                class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-700">
                                                {{ \App\Models\InvestmentOpeningBalance::count() }}
                                            </span>
                                            <svg class="w-4 h-4 text-gray-400 group-hover:text-gray-600 transition-colors"
                                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                @canany(['stock-adjustment-list', 'product-recall-list', 'supplier-payment-list'])
                    <div x-data="{ open: true }" class="bg-white rounded-lg shadow overflow-hidden">
                        <button @click="open = !open" type="button"
                            class="w-full flex items-center justify-between px-6 py-4 hover:bg-gray-50 transition-colors duration-150">
                            <div class="flex items-center gap-3">
                                    ...
                                    <a href="{{ route('supplier-payments.index') }}"
                                        ...
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <div class="text-xs text-gray-500">Payment vouchers & records for suppliers
                                                </div>
                                            </div>
                                        </div>
                                        <div class="flex items-center gap-3">
                                            <span
                                                class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-700">
                                                {{ \App\Models\SupplierPayment::count() }}
                                            </span>
                                            <svg class="w-4 h-4 text-gray-400 group-hover:text-gray-600 transition-colors"
                                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
