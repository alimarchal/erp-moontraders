<x-app-layout>
    <x-slot name="header">
        <x-page-header title="Sales Settlements" :createRoute="route('sales-settlements.create')" createLabel=""
            createPermission="sales-settlement-create" :showSearch="true" :showRefresh="true" />
    </x-slot>
                            ...
                            @foreach ($settlements as $index => $settlement)
                                <tr>
                                    ...
                                    <td class="text-right tabular-nums text-black-500">
                                        {{ number_format($settlement->calculated_total_cogs, 2) }}
                                    </td>

                                    <td class="text-right tabular-nums font-bold">
                                        {{ number_format($settlement->calculated_total_sales_amount, 2) }}
                                    </td>
                                    @php
                                        // Use calculated net profit from accessor
                            ...
                            <table class="report-table w-full">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-right tabular-nums font-bold text-black">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right tabular-nums font-bold text-red-600 print:text-black">
                            ...
                            <table class="report-table w-full">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right tabular-nums font-bold text-green-600 print:text-black">
