                        ...
                        <a href="{{ route('reports.salesman-stock-register.index') }}"
                            ...
                            <div class="p-5 flex justify-between">
                                <div>
                                    ...
                                    <div class="mt-1 text-base font-extrabold text-gray-700">Salesman Stock Register</div>
                                </div>
                                <!-- Icon: Truck/Van -->
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
            ...
            @can('report-view-inventory')
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-12 gap-6">
                        ...
                        <!-- Daily Stock Register Report Card -->
                        <a href="{{ route('reports.daily-stock-register.index') }}"
                            class="transform hover:scale-105 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 md:col-span-4 lg:col-span-3 intro-y bg-white block">
                            <div class="p-5 flex justify-between">
                                <div>
                                    <div class="text-3xl font-bold leading-8 text-gray-800">DSR</div>
                                    <div class="mt-1 text-base font-extrabold text-gray-700">Daily Stock</div>
                                    <div class="text-xs text-gray-500 mt-1">Stock Register</div>
                                </div>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                    stroke="currentColor" class="h-16 w-16 text-purple-600">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-12 gap-6">
                        ...
                        <a href="{{ route('reports.cash-detail.index') }}"
                            ...
                            <div class="p-5 flex justify-between">
                                <div>
                                    <div class="text-3xl font-bold leading-8 text-gray-800">CD</div>
                                    <div class="mt-1 text-base font-extrabold text-gray-700">Cash Detail</div>
                                    <div class="text-xs text-gray-500 mt-1">Cash Collection Report</div>
                                </div>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                    stroke="currentColor" class="h-16 w-16 text-emerald-600">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <!-- Custom Settlement Report Card -->
                        <a href="{{ route('reports.custom-settlement.index') }}"
                            class="transform hover:scale-105 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 md:col-span-4 lg:col-span-3 intro-y bg-white block">
                            <div class="p-5 flex justify-between">
                                <div>
                                    <div class="text-3xl font-bold leading-8 text-gray-800">CSR</div>
                                    <div class="mt-1 text-base font-extrabold text-gray-700">Custom Settlement</div>
                                    <div class="text-xs text-gray-500 mt-1">Settlement Report</div>
                                </div>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                    stroke="currentColor" class="h-16 w-16 text-blue-600">
                                    <path stroke-linecap="round" stroke-linejoin="round"
