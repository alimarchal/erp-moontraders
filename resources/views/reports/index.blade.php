        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                @canany(['report-financial-general-ledger', 'report-financial-trial-balance', 'report-financial-account-balances', 'report-financial-balance-sheet', 'report-financial-income-statement', 'report-audit-opening-customer-balance'])
                    <div>
                        <p class="px-4 mb-1 text-[11px] font-semibold uppercase tracking-widest text-gray-500">Financial Statements</p>
                        <div class="bg-white rounded-2xl overflow-hidden shadow-2xl hover:shadow-[0_20px_60px_-10px_rgba(0,0,0,0.15)] hover:-translate-y-0.5 transition-all duration-200">
                            ...
                            @can('report-financial-account-balances')
                                ...
                                <x-settings-row href="{{ route('reports.account-balances.index') }}" label="Account Balances"
                                    description="Summary of all account positions"
                            ...
                            @can('report-audit-opening-customer-balance')
                                <div class="ml-[58px] h-px bg-gray-100"></div>
                                <x-settings-row href="{{ route('reports.opening-customer-balance.index') }}" label="Opening Customer Balance"
                                    description="Customer opening balances per salesman"
                                    icon-bg="bg-cyan-500">
                                    <x-slot name="icon">
                                        <svg class="w-[18px] h-[18px] text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 013 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 00-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 01-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 003 15h-.75M15 10.5a3 3 0 11-6 0 3 3 0 016 0zm3 0h.008v.008H18V10.5zm-12 0h.008v.008H6V10.5z" />
                ...
                @canany(['report-audit-creditors-ledger', 'report-sales-credit-sales', 'report-audit-cash-detail', 'report-audit-investment-summary', 'report-audit-claim-register', 'report-audit-ledger-register'])
                    <div>
                        <p class="px-4 mb-1 text-[11px] font-semibold uppercase tracking-widest text-gray-500">Receivables &amp; Core Reports</p>
                        <div class="bg-white rounded-2xl overflow-hidden shadow-2xl hover:shadow-[0_20px_60px_-10px_rgba(0,0,0,0.15)] hover:-translate-y-0.5 transition-all duration-200">
                            @can('report-audit-creditors-ledger')
                                <x-settings-row href="{{ route('reports.creditors-ledger.index') }}" label="Creditors Ledger"
                                    description="Outstanding balances by creditor"
                            ...
                            @can('report-sales-credit-sales')
                                <div class="ml-[58px] h-px bg-gray-100"></div>
                                <x-settings-row href="{{ route('reports.credit-sales.salesman-history') }}" label="Salesman Credit History"
                                    description="Credit sales history per salesman"
                                    icon-bg="bg-cyan-500">
                                    <x-slot name="icon">
                                        <svg class="w-[18px] h-[18px] text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8">
                            ...
                            @can('report-audit-cash-detail')
                                ...
                                <x-settings-row href="{{ route('reports.cash-detail.index') }}" label="Cash Collection Detail"
                                    description="Daily cash collection breakdown"
                                    icon-bg="bg-emerald-500">
                                    <x-slot name="icon">
                                        <svg class="w-[18px] h-[18px] text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182s2.9-.879 4.006 0l.415.33M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                            ...
                            @can('report-audit-investment-summary')
                                <div class="ml-[58px] h-px bg-gray-100"></div>
                                <x-settings-row href="{{ route('reports.investment-summary.index') }}" label="Investment Summary"
                                    description="Daily investment position summary"
                                    icon-bg="bg-green-500">
                                    <x-slot name="icon">
                                        <svg class="w-[18px] h-[18px] text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8">
                            ...
                            @can('report-audit-claim-register')
                                ...
                                <x-settings-row href="{{ route('reports.claim-register.index') }}" label="Claim Register"
                                    description="Supplier claims and recovery tracking"
                            ...
                            @can('report-audit-ledger-register')
                                <div class="ml-[58px] h-px bg-gray-100"></div>
                                <x-settings-row href="{{ route('reports.ledger-register.index') }}" label="Supplier Ledger Register"
                                    description="Supplier transaction ledger with running balance"
                                    icon-bg="bg-teal-500">
                                    <x-slot name="icon">
                                        <svg class="w-[18px] h-[18px] text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" />
                ...
                @canany(['report-sales-fmr-amr-comparison', 'report-audit-sku-fmr-amr', 'report-audit-stock-availability', 'report-sales-shop-list', 'report-sales-sku-rates', 'report-audit-expense-detail'])
                    <div>
                        <p class="px-4 mb-1 text-[11px] font-semibold uppercase tracking-widest text-gray-500">Audit &amp; Product Reports</p>
                        <div class="bg-white rounded-2xl overflow-hidden shadow-2xl hover:shadow-[0_20px_60px_-10px_rgba(0,0,0,0.15)] hover:-translate-y-0.5 transition-all duration-200">
                            @can('report-sales-fmr-amr-comparison')
                                <x-settings-row href="{{ route('reports.fmr-amr-comparison.index') }}" label="FMR vs AMR Comparison"
                                    description="Factory vs actual movement reconciliation"
                                    icon-bg="bg-rose-500">
                                    <x-slot name="icon">
                                        <svg class="w-[18px] h-[18px] text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8">
                            ...
                            @can('report-audit-sku-fmr-amr')
                                ...
                                <x-settings-row href="{{ route('reports.sku-fmr-amr.index') }}" label="SKU-wise FMR vs AMR"
                                    description="Product-level FMR & AMR breakdown by SKU"
                                    icon-bg="bg-pink-500">
                                    <x-slot name="icon">
                                        <svg class="w-[18px] h-[18px] text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8">
                            ...
                            @can('report-audit-stock-availability')
                                <div class="ml-[58px] h-px bg-gray-100"></div>
                                <x-settings-row href="{{ route('reports.stock-availability.index') }}" label="Stock Availability"
                                    description="Current & historical stock by supplier"
                                    icon-bg="bg-indigo-500">
                                    <x-slot name="icon">
                                        <svg class="w-[18px] h-[18px] text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8">
                            ...
                            @can('report-sales-shop-list')
                                ...
                                <x-settings-row href="{{ route('reports.shop-list.index') }}" label="Shop Directory"
                                    description="Registered retail outlet listings"
                                    icon-bg="bg-sky-500">
                                    <x-slot name="icon">
                                        <svg class="w-[18px] h-[18px] text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8">
                            ...
                            @can('report-sales-sku-rates')
                                ...
                                <x-settings-row href="{{ route('reports.sku-rates.index') }}" label="SKU &amp; Pricing"
                                    description="Product codes and pricing schedule"
                                    icon-bg="bg-amber-500">
                                    <x-slot name="icon">
                                        <svg class="w-[18px] h-[18px] text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8">
                            ...
                            @can('report-audit-expense-detail')
                                ...
                                <x-settings-row href="{{ route('reports.expense-detail.index') }}" label="Expense Detail"
                                    description="Track & manage operational expenses by category"
                                    icon-bg="bg-red-500">
                                    <x-slot name="icon">
                                        <svg class="w-[18px] h-[18px] text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 013 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 00-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 01-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 003 15h-.75M15 10.5a3 3 0 11-6 0 3 3 0 016 0zm3 0h.008v.008H18V10.5zm-12 0h.008v.008H6V10.5z" />
                ...
                @canany(['report-inventory-daily-stock-register', 'report-inventory-salesman-stock-register', 'report-inventory-inventory-ledger', 'report-inventory-van-stock-batch', 'report-inventory-van-stock-ledger'])
                    <div>
                        <p class="px-4 mb-1 text-[11px] font-semibold uppercase tracking-widest text-gray-500">Inventory Management</p>
                        <div class="bg-white rounded-2xl overflow-hidden shadow-2xl hover:shadow-[0_20px_60px_-10px_rgba(0,0,0,0.15)] hover:-translate-y-0.5 transition-all duration-200">
                            @can('report-inventory-daily-stock-register')
                                <x-settings-row href="{{ route('reports.daily-stock-register.index') }}" label="Daily Stock Register"
                                    description="End-of-day stock position summary"
                                    icon-bg="bg-emerald-500">
                                    <x-slot name="icon">
                                        <svg class="w-[18px] h-[18px] text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75 2.25 2.25 0 00-.1-.664m-5.8 0A2.251 2.251 0 0113.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25zM6.75 12h.008v.008H6.75V12zm0 3h.008v.008H6.75V15zm0 3h.008v.008H6.75V18z" />
                            ...
                            @can('report-inventory-salesman-stock-register')
                                <div class="ml-[58px] h-px bg-gray-100"></div>
                                <x-settings-row href="{{ route('reports.salesman-stock-register.index') }}" label="Salesman Stock Register"
                                    description="Stock allocated per salesman"
                                    icon-bg="bg-purple-500">
                                    <x-slot name="icon">
                                        <svg class="w-[18px] h-[18px] text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8">
                            ...
                            @can('report-inventory-van-stock-ledger')
                                ...
                                <x-settings-row href="{{ route('reports.van-stock-ledger.index') }}" label="Van Stock Ledger"
                                    description="Van stock transaction history"
                                    icon-bg="bg-teal-500">
                                    <x-slot name="icon">
                                        <svg class="w-[18px] h-[18px] text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h1.125c.621 0 1.125-.504 1.125-1.125V13.5m-9-3.75h3.375c.621 0 1.125.504 1.125 1.125v1.5c0 .621-.504 1.125-1.125 1.125h-3.375m0 0H6.375c-.621 0-1.125-.504-1.125-1.125v-1.5c0-.621.504-1.125 1.125-1.125h3.375m0 0v-2.25" />
                                        </svg>
                                    </x-slot>
                                </x-settings-row>
                            @endcan
                            @can('report-inventory-van-stock-batch')
                                ...
                                <x-settings-row href="{{ route('reports.van-stock-batch.index') }}" label="Van Stock by Batch"
                                    description="Batch-level van inventory details"
                                    icon-bg="bg-indigo-500">
                                    <x-slot name="icon">
                                        <svg class="w-[18px] h-[18px] text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8">
                            ...
                            @can('report-inventory-inventory-ledger')
                                ...
                                <x-settings-row href="{{ route('reports.inventory-ledger.index') }}" label="Inventory Ledger"
                                    description="Double-entry stock movement tracking"
                ...
                @canany(['report-sales-goods-issue', 'report-sales-daily-sales', 'report-sales-vehicle', 'report-audit-product-price-change-log'])
                    <div>
                        <p class="px-4 mb-1 text-[11px] font-semibold uppercase tracking-widest text-gray-500">Distribution &amp; Logistics</p>
                        <div class="bg-white rounded-2xl overflow-hidden shadow-2xl hover:shadow-[0_20px_60px_-10px_rgba(0,0,0,0.15)] hover:-translate-y-0.5 transition-all duration-200">
                            @can('report-sales-goods-issue')
                                <x-settings-row href="{{ route('reports.goods-issue.index') }}" label="Goods Issue Report"
                                    description="Outward dispatch and delivery records"
                                    icon-bg="bg-blue-500">
                                    <x-slot name="icon">
                                        <svg class="w-[18px] h-[18px] text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8">
                            ...
                            @can('report-sales-daily-sales')
                                ...
                                <x-settings-row href="{{ route('reports.daily-sales.van-stock') }}" label="Van Stock Status"
                                    description="Current van inventory levels"
                                    icon-bg="bg-orange-500">
                                    <x-slot name="icon">
                                        <svg class="w-[18px] h-[18px] text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h1.125c.621 0 1.125-.504 1.125-1.125V13.5m-9-3.75h3.375c.621 0 1.125.504 1.125 1.125v1.5c0 .621-.504 1.125-1.125 1.125h-3.375m0 0H6.375c-.621 0-1.125-.504-1.125-1.125v-1.5c0-.621.504-1.125 1.125-1.125h3.375m0 0v-2.25" />
                            ...
                            @can('report-sales-vehicle')
                                ...
                                <x-settings-row href="{{ route('reports.vehicle.index') }}" label="Vehicle Report"
                                    description="Fleet details and assignments"
                                    icon-bg="bg-indigo-500">
                                    <x-slot name="icon">
                                        <svg class="w-[18px] h-[18px] text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h1.125c.621 0 1.125-.504 1.125-1.125V13.5m-9-3.75h3.375c.621 0 1.125.504 1.125 1.125v1.5c0 .621-.504 1.125-1.125 1.125h-3.375m0 0H6.375c-.621 0-1.125-.504-1.125-1.125v-1.5c0-.621.504-1.125 1.125-1.125h3.375m0 0v-2.25" />
                            ...
                            @can('report-audit-product-price-change-log')
                                <div class="ml-[58px] h-px bg-gray-100"></div>
                                <x-settings-row href="{{ route('reports.product-price-change-log.index') }}" label="Product Price Change Log"
                                    description="Audit trail of all price changes & impacted batches"
                                    icon-bg="bg-blue-500">
                                    <x-slot name="icon">
                                        <svg class="w-[18px] h-[18px] text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8">
                ...
                {{-- ─── Supplier Reports ─── --}}
                @canany(['report-audit-invoice-summary', 'report-audit-custom-settlement', 'report-audit-percentage-expense', 'report-audit-advance-tax'])
                    <div>
                        ...
                        <div class="bg-white rounded-2xl overflow-hidden shadow-2xl hover:shadow-[0_20px_60px_-10px_rgba(0,0,0,0.15)] hover:-translate-y-0.5 transition-all duration-200">
                            @can('report-audit-invoice-summary')
                                <x-settings-row href="{{ route('reports.invoice-summary.index') }}" label="Invoice Summary"
                                    description="Supplier invoice summary with tax breakdown"
                                    icon-bg="bg-purple-500">
                                    <x-slot name="icon">
                                        <svg class="w-[18px] h-[18px] text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75 2.25 2.25 0 00-.1-.664m-5.8 0A2.251 2.251 0 0113.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25zM6.75 12h.008v.008H6.75V12zm0 3h.008v.008H6.75V15zm0 3h.008v.008H6.75V18z" />
                            ...
                            @can('report-audit-custom-settlement')
                                ...
                                <x-settings-row href="{{ route('reports.custom-settlement.index') }}" label="Custom Settlement"
                                    description="Custom settlement transactions"
                                    icon-bg="bg-blue-500">
                                    <x-slot name="icon">
                                        <svg class="w-[18px] h-[18px] text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75 2.25 2.25 0 00-.1-.664m-5.8 0A2.251 2.251 0 0113.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25zM6.75 12h.008v.008H6.75V12zm0 3h.008v.008H6.75V15zm0 3h.008v.008H6.75V18z" />
                            ...
                            @can('report-audit-percentage-expense')
                                <div class="ml-[58px] h-px bg-gray-100"></div>
                                <x-settings-row href="{{ route('reports.percentage-expense.index') }}" label="Expense Analysis"
                                    description="Expense percentage and distribution"
                                    icon-bg="bg-violet-500">
                                    <x-slot name="icon">
                                        <svg class="w-[18px] h-[18px] text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8">
                            ...
                            @can('report-audit-advance-tax')
                                ...
                                <x-settings-row href="{{ route('reports.advance-tax.index') }}" label="Advance Tax Report"
                                    description="Advance tax computation and records"
                                    icon-bg="bg-red-500">
                                    <x-slot name="icon">
                                        <svg class="w-[18px] h-[18px] text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8">
                ...
                @canany(['report-sales-daily-sales', 'report-sales-credit-sales', 'report-sales-settlement', 'report-sales-roi', 'report-sales-scheme-discount'])
                    <div>
                        <p class="px-4 mb-1 text-[11px] font-semibold uppercase tracking-widest text-gray-500">Sales &amp; Revenue</p>
                        <div class="bg-white rounded-2xl overflow-hidden shadow-2xl hover:shadow-[0_20px_60px_-10px_rgba(0,0,0,0.15)] hover:-translate-y-0.5 transition-all duration-200">
                            @can('report-sales-daily-sales')
                                <x-settings-row href="{{ route('reports.daily-sales.index') }}" label="Daily Sales Summary"
                                    description="Consolidated daily revenue overview"
                                    icon-bg="bg-green-500">
                                    <x-slot name="icon">
                                        <svg class="w-[18px] h-[18px] text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8">
                                ...
                                <div class="ml-[58px] h-px bg-gray-100"></div>
                                <x-settings-row href="{{ route('reports.daily-sales.salesman-wise') }}" label="Sales by Salesman"
                                    description="Individual salesman performance analysis"
                                    icon-bg="bg-blue-500">
                                    <x-slot name="icon">
                                        <svg class="w-[18px] h-[18px] text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z" />
                            ...
                            @can('report-sales-settlement')
                                ...
                                <x-settings-row href="{{ route('reports.sales-settlement.index') }}" label="Sales Settlement"
                                    description="Settlement and reconciliation records"
                                    icon-bg="bg-teal-500">
                                    <x-slot name="icon">
                                        <svg class="w-[18px] h-[18px] text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8">
                            ...
                            @can('report-sales-roi')
                                ...
                                <x-settings-row href="{{ route('reports.roi.index') }}" label="Return on Investment"
                                    description="Profitability and ROI analysis"
                                    icon-bg="bg-indigo-500">
                                    <x-slot name="icon">
                                        <svg class="w-[18px] h-[18px] text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18L9 11.25l4.306 4.307a11.95 11.95 0 015.814-5.519l2.74-1.22m0 0l-5.94-2.28m5.94 2.28l-2.28 5.941" />
                            ...
                            @can('report-sales-scheme-discount')
                                <div class="ml-[58px] h-px bg-gray-100"></div>
                                <x-settings-row href="{{ route('reports.scheme-discount.index') }}" label="Schemes &amp; Discounts"
                                    description="Promotional scheme and discount tracking"
                                    icon-bg="bg-pink-500">
                                    <x-slot name="icon">
                                        <svg class="w-[18px] h-[18px] text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8">
