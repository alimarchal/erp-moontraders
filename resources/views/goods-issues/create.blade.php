<x-app-layout>
    ...
    <script>
        ...
        async function initializeProductSelect2(index) {
            ...
            // Set initial value from Alpine.js data if loading old data
        ...
        async function onProductChange(index, productId, warehouseId) {
            ...
            try {
                ...
                // Clear quantity and price for new product selection
        ...
        function initializeGoodsIssueForm() {
            ...
            $(document).ready(function() {
                ...
                // Initialize product selects for existing items (from old input)
                ...
                $('#warehouse_id').on('change', function() {
                    ...
                    if (alpineComponent && alpineComponent.items.length > 0 && alpineComponent.items[0].product_id) {
