    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div
                    class="bg-white shadow-md rounded-lg p-4 border border-gray-200/60/70">
            ...
            <div
                class="bg-white shadow-md rounded-lg border border-gray-200/70/60">
                <div class="p-4 border-b border-gray-200 flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-3">
                        <button type="button" onclick="window.dispatchEvent(new CustomEvent('coa-expand-all'))"
                            class="inline-flex items-center px-3 py-1.5 bg-indigo-50 text-indigo-600 text-xs font-semibold rounded-md hover:bg-indigo-100/10/20 transition">
                        ...
                        <button type="button" onclick="window.dispatchEvent(new CustomEvent('coa-collapse-all'))"
                            class="inline-flex items-center px-3 py-1.5 bg-slate-50 text-slate-600 text-xs font-semibold rounded-md hover:bg-slate-100/10/20 transition">
                            <svg class="w-4 h-4 mr-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
