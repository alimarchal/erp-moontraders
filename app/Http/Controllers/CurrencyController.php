...
class CurrencyController extends Controller implements HasMiddleware
{
    ...
    {
        return [
            new Middleware('can:currency-list', only: ['index', 'show']),
            new Middleware('can:currency-create', only: ['create', 'store']),
            new Middleware('can:currency-edit', only: ['edit', 'update']),
            new Middleware('can:currency-delete', only: ['destroy']),
        ];
    }
