            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea rows="3"
                            class="mt-1 block w-full border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200 rounded-md shadow-sm cursor-not-allowed"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <div class="p-4 bg-gray-50 dark:bg-gray-900 rounded-lg border border-gray-200">
