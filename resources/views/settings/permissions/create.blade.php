<x-app-layout title="Create Permission">
    <x-page-header title="Create New Permission" :breadcrumbs="[
        ['label' => 'Settings', 'url' => '#'],
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <p class="mt-2 text-sm text-gray-500">
                                    Recommended format: <code
                                        class="bg-gray-100 dark:bg-gray-700 px-1 rounded">module-action</code> (e.g.,
                                    <code class="bg-gray-100 dark:bg-gray-700 px-1 rounded">user-list</code>)
                                </p>
                            </div>
