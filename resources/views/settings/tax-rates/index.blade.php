<x-app-layout>
    <x-slot name="header">
        <x-page-header title="Tax Rates" :createRoute="route('tax-rates.create')" createLabel="Add Tax Rate"
            createPermission="tax-create" :showSearch="true" :showRefresh="true" backRoute="settings.index" />
    </x-slot>
    ...
    <x-data-table :items="$taxRates" :headers="[
        ...
        :emptyRoute="route('tax-rates.create')" emptyLinkText="Add a tax rate">
