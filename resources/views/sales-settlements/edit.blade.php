                                                ...
                                                <template x-for="(expense, index) in expenses" :key="expense.id">
                                                    <tr class="hover:bg-gray-50">
                                                        <td class="py-1 px-1 text-xs">
                                                            <template
                                                                x-if="expense.is_predefined && ![20, 70, 71].includes(parseInt(expense.expense_account_id))">
                                                                <span
                                                        ...
                                                        <td class="py-1 px-1 text-right">
                                                            <input type="number" :id="'expense_amount_' + expense.id"
                                                                ...
                                                                :readonly="[20, 70, 71].includes(parseInt(expense.expense_account_id))"
                                                                :class="[20, 70, 71].includes(parseInt(expense.expense_account_id)) ? 'bg-gray-100 cursor-not-allowed' : ''"
