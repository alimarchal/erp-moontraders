        ...
        ['label' => 'B/F (Out)', 'align' => 'text-right'],
                    ...
                    <div class="pr-6 pl-6 pt-2">
                        ...
                        <div id="expenseAndSalesSummarySection" class="mb-4">
                            ...
                            {{-- ROW 1: Credit Sales Detail | Cheque Payments | Bank Transfers --}}
                                    ...
                                    <div class="p-0">
                                        <table class="w-full text-xs">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="border-t border-gray-200">
                                                    <td class="py-1 px-1 text-xs text-black">Bank Sale Amount</td>
    ...
    @push('scripts')
        <script>
            ...
            function updateSalesSummary() {
                ...
                // Create or update hidden input for bank_sales_amount
                let bankSalesInput = document.getElementById('bank_sales_amount');
                if (!bankSalesInput) {
                    bankSalesInput = document.createElement('input');
                    bankSalesInput.type = 'hidden';
                    bankSalesInput.id = 'bank_sales_amount';
                    bankSalesInput.name = 'bank_sales_amount';
